                ...
                <div className="bg-gray-100 dark:bg-gray-700 rounded-full h-2 w-32 overflow-hidden">
                  <div 
                    className={`h-full transition-all duration-1000 ${
                      showSolution ? 'bg-green-500 w-full' : 'bg-blue-500 w-1/2'
                    }`}
                  ></div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
                <div className="p-6 md:p-8">
                  ...
                  <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-8">
                    ...
                    <span className={`self-start px-3 py-1 rounded-full text-sm font-medium whitespace-nowrap ${
                      exercise?.difficulty === 'easy' ? 'bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-200' :
