...
export default function RoadmapEditor({ params }: { params: { roadmapId: string } }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-[var(--primary-color-light)]/30 dark:from-gray-900 dark:to-indigo-950/30 text-gray-800 dark:text-gray-200 pb-24">
        ...
        <div className="mb-8">
          <Breadcrumb
            items={[
              ...
              { name: isNewRoadmap ? 'New' : roadmapData?.title, href: '#' }
            ]}
          />
        </div>
