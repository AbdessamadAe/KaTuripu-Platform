          ...
          <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
            <div className="space-y-6">
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 w-full'>
                ...
                <div>
                  <label htmlFor="description-preview" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    Preview
                  </label>
                  <div className="border border-gray-200 dark:border-gray-600 rounded-md overflow-y-auto min-h-[140px]" style={{ maxHeight: '140px' }}>
                    <MathBlock content={formData.description || ''} />
                  </div>
                </div>
              </div>

              {/* Choices - Largest component by functionality */}
              <div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 w-full'>
                ...
                <div>
                  <label htmlFor="explanation-preview" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    Preview
                  </label>
                  <div className="border border-gray-200 dark:border-gray-600 rounded-md overflow-y-auto min-h-[140px]" style={{ maxHeight: '140px' }}>
              ...
              {/* URLs - Put Video URL and Image URL side by side */}
