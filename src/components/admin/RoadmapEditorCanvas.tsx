        ...
        <Panel position="top-left" className="bg-white dark:bg-gray-800 p-2 rounded shadow">
          <div className="flex space-x-2">
            <button
              ...
              className="px-3 py-1 bg-[var(--primary-color)] hover:bg-[var(--primary-color-dark)] text-white rounded text-sm flex items-center"
            >
          ...
          <Panel position="top-right" className="bg-white dark:bg-gray-800 p-2 rounded shadow">
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="px-3 py-1 bg-[var(--error-color)] hover:bg-[var(--error-color-dark)] text-white rounded text-sm flex items-center"
              >
                <svg className="w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
