    ...
    <div>
      <div className='pt-[50px]  w-full h-screen m-t-[-96px] mx-auto flex items-center justify-center space-x-[100px]'>
        <div className='flex flex-col text-center items-center font-amiri'>
          <h1 className=' text-[#1F2937] pb-3 font-bold text-h1 '>
            إكتشف. تعلم. إستمتع
          </h1>
          <h6 className='text-primary-color pb-7  font-bold text-h6'>
            أول منصة مغاربية لتعلم الرياضيات
          </h6>
          <button class="bg-primary-color w-fit items-center hover:bg-blue-700 text-white py-[8px] px-[40px] rounded-full">
            إقرأ المزيد
          </button>
        </div>
        <div>
