...
const RoadmapsPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-gray-800 text-gray-800 dark:text-gray-200 py-12">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-10 max-w-4xl mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    ...
                    <div className="relative w-full lg:w-3/5">
                        <div className="relative">
                            {/* Decorative element */}
                            <div className="absolute -z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-24 bg-blue-100 dark:bg-blue-900/20 rounded-full blur-xl opacity-50"></div>
                            
                            <input
                                type="text"
                                placeholder={t('searchPlaceholder')}
                                className="w-full px-5 py-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg focus:shadow-xl focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-500 focus:border-blue-400 dark:focus:border-blue-500 outline-none transition dark:bg-gray-800 dark:text-gray-200 dark:placeholder-gray-400 bg-white"
                                value={searchTerm}
                ...
                <div className="relative">
                    ...
                    <div className="absolute -z-10 top-1/3 left-1/4 w-64 h-64 bg-blue-100 dark:bg-blue-900/20 rounded-full blur-3xl opacity-40"></div>
                    <div className="absolute -z-10 bottom-1/4 right-1/5 w-72 h-72 bg-purple-100 dark:bg-purple-900/20 rounded-full blur-3xl opacity-40"></div>
                    ...
                    {filteredRoadmaps.length === 0 ? (
                        <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-100 dark:border-gray-700">
                            ...
                            <p className="text-gray-500 dark:text-gray-400 mb-4 text-lg">{t('noRoadmapsFound')}</p>
                            <button
                                onClick={() => { setSearchTerm(''); setCategory('all'); }}
                                className="px-6 py-2.5 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-800/40 transition-colors"
                            >
                                {t('resetFilters')}
                            </button>
                        </div>
