            ...
            <div className="container mt-12 mx-auto px-4 md:px-8 lg:px-16 pb-16">
                <div className="mb-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div className="relative w-full lg:w-1/2">
                        <input
                            ...
                            className="w-full px-5 py-3 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-500 focus:border-blue-400 dark:focus:border-blue-500 outline-none transition dark:bg-gray-800 dark:text-gray-200 dark:placeholder-gray-400"
                            value={searchTerm}
                ...
                {filteredRoadmaps.length === 0 ? (
                    <div className="text-center py-12">
                        <p className="text-gray-500 dark:text-gray-400 mb-4">{t('noRoadmapsFound')}</p>
                        <button
