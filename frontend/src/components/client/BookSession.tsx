    ...
    return (
        <div>
            ...
            <div className='animate-slide-fade-in sm:p-4 pt-6 sm:pt-10 pb-0'>
                <div className=" relative mt-[80px] grid grid-flow-col grid-cols-1 items-center my-auto mx-auto max-w-[80%] bg-white font-amiri">
                    <img src="/images/purple_illust.svg" className=' hidden sm:block absolute -top-20 right-10 w-[130px]' alt="illustration" />
                    <div className='grid grid-flow-row text-center'>
                        <div className='space-y-3' id="booking-section" dir="rtl" lang="ar" >
                            ...
                            <div>
                                ...
                                <button onClick={() => { window.location.href = '#booking-form' }} className=" my-3 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300 bg-[#7C3AED] w-fit items-center hover:bg-primary-color text-white py-[8px] px-[40px] rounded-full">
                                    احجز الآن
                                </button>
                            </div>
                        </div>
